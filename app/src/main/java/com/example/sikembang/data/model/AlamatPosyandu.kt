...
data class AlamatPosyandu(
    ...
    @get:PropertyName("nama_posyandu")
    @set:PropertyName("nama_posyandu")
    var namaPosyandu: String = "",

    @get:PropertyName("alamat_lengkap")
    @set:PropertyName("alamat_lengkap")
    ...
    @get:PropertyName("kode_pos")
    @set:PropertyName("kode_pos")
    var kodePos: String = "",
    ...
    @get:PropertyName("jam_operasional")
    @set:PropertyName("jam_operasional")
    var jamOperasional: JamOperasional = JamOperasional(),

    @get:PropertyName("kegiatan_terbaru")
    @set:PropertyName("kegiatan_terbaru")
    var kegiatanTerbaru: String = "",

    @get:PropertyName("fasilitas_tersedia")
    @set:PropertyName("fasilitas_tersedia")
    var fasilitasTersedia: List<String> = emptyList(),

    @get:PropertyName("penanggung_jawab")
    @set:PropertyName("penanggung_jawab")
    var penanggungJawab: String = "",

    val rating: Double = 0.0,

    @get:PropertyName("jumlah_ulasan")
    @set:PropertyName("jumlah_ulasan")
    var jumlahUlasan: Int = 0,
